...
class ItemServiceIntegrationTest {
    ...
    void createItem_returnCreatedItem() {
        ...
        Assertions.assertThat(result.getId()).isEqualTo(result.getId());
    ...
    void getAllItemsByUserId_notEmptyListItems_itemsExist() {
        ...
        Assertions.assertThat(result.get(0).getDescription()).isEqualTo(item.getDescription());
    }
    ...
    void searchItemByText_notEmptyListItems_itemsExist() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        assertThat(result.size()).isEqualTo(1);
        Assertions.assertThat(result.get(0).getName()).isEqualTo("Test name");
    }
    ...
    void createComment_noFoundObjectException_userExistAndItemDoNotExist() {
        ...
        org.junit.jupiter.api.Assertions.assertEquals("Item with id='100' not found", exception.getMessage());
    }
    ...
    void getAllByRequestIds_notEmptyListItems_itemsExist() {
        ...
        RequestDto request = RequestDto.builder()
                ...
                .build();
        RequestDto savedRequest = requestService.createRequest(request, savedUser.getId());
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.get(0).getRequest().getId()).isEqualTo(savedItem.getRequestId());
    }
    ...
    void getItemByRequestId_notEmptyListItems_itemsExist() {
        ...
        Assertions.assertThat(result.getName()).isEqualTo(savedItem.getName());
        Assertions.assertThat(result.getRequest().getId()).isEqualTo(savedRequest.getId());
    }
    ...
    void updateItemById_updatedItem_itemExist() {
        ...
        Assertions.assertThat(result).isNotNull();
        Assertions.assertThat(result.getName()).isEqualTo(updateRequest.getName());
    }
