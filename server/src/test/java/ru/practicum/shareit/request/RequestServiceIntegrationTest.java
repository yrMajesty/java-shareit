...
class RequestServiceIntegrationTest {
    private final RequestService underTest;
    ...
    void createRequest_createdRequest_userExist() {
        ...
        Assertions.assertThat(result.getDescription()).isEqualTo(request.getDescription());
    }
    ...
    void getOwnerRequestByUserId_notEmptyResultList_requestExist() {
        ...
        Assertions.assertThat(result.get(0).getId()).isEqualTo(createdRequest.getId());
    }
    ...
    void getRequestsOtherUsers_emptyResultList_requestFromOtherUser() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.get(0).getDescription()).isEqualTo(requestDto.getDescription());
    }
