...
public class EndDateValidator implements ConstraintValidator<EndDateIsAfterStartDate, Object> {
    ...
    public boolean isValid(Object object, ConstraintValidatorContext context) {
        final Object startDateObject = new BeanWrapperImpl(object).getPropertyValue(startFieldName);
        final Object endDateObject = new BeanWrapperImpl(object).getPropertyValue(endFieldName);
