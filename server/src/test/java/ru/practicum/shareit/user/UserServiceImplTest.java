...
class UserServiceImplTest {
    ...
    void updateUserById_successfulUpdate_userIdIsCorrect() {
        ...
        Assertions.assertThat(result.getName()).isEqualTo("Nikita new");
        Assertions.assertThat(result.getEmail()).isEqualTo(request.getEmail());
    }
    ...
    void getUserById_correctUser_userIsExist() {
        ...
        Assertions.assertThat(result.getName()).isEqualTo("Nikita");
    }
